...
public class HW3 {
  ...
  public static void main(String[] args) {
    if (args.length < 4) {
      System.out
          .println("usage: java HW3 <modeFlag> <trainFilename> " + "<tuneFilename> <testFilename>");
      System.exit(-1);
    }
    ...
    if (mode % 2 == 1) {
     ...
     System.out.printf("Training Set Accuracy: %.5f\n", tree.getAccuracy(trainSet));
    System.out.printf("Test Set Accuracy: %.5f ", tree.getAccuracy(testSet));
    }
  }
